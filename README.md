...
| 78 unit + 12 doctests + 4 compile-fail | Behaviour, including threaded stress tests for all SPSC types; `N == 0` rejected at compile time; `LatestBuf`'s absent `Source` impl pinned (D2) |
